...
namespace ToDoApp
{
    public class ToDoOperations
    {
        ...
        public void AddTodo(List<Card> todoList) {
            Console.WriteLine();
            ...
            try {
                ...
                todoList.Add(new Card(title, content, drtn, person));
                Console.WriteLine();
        ...
        public void UpdateStatus(List<Card> todoList) {
            Console.WriteLine("Öncelikle taşımak istediğiniz kartı seçmeniz gerekiyor.");
            Console.Write("Lütfen kart başlığını yazınız: ");
            string input = Console.ReadLine();

            List<Card> result = todoList.FindAll(x=> x.GetTitle() == input);
        ...
        public void DeleteTodo(List<Card> todoList){
